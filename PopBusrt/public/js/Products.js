...
// Función para buscar productos haciendo una solicitud a la API
function buscarProductos() {
    ...
    var apiUrl = 'http://ruta-de-tu-api/buscar-productos?' +
        new URLSearchParams({
            nombre: nombre,
            categoria: categoria,
            precioMin: precioMin,
    ...
    fetch(apiUrl)
        ...
        .then(function (data) {
            // Limpiar los productos actuales en el DOM
            var contenedorProductos = document.querySelector('.contenedor-items');
            contenedorProductos.innerHTML = '';

            // Agregar los nuevos productos obtenidos de la API al DOM
...
function agregarProductoAlDOM(producto) {
    // Obtener el contenedor de productos en el DOM
    var contenedorProductos = document.querySelector('.contenedor-items');
    ...
    // Configurar el contenido HTML del nuevo producto
    nuevoProducto.innerHTML = `
        <i class='bx bx-heart' style='float: right;'></i>
        <span class="titulo-item">${producto.nombre}</span>
        <img src="${producto.imagenSrc}" alt="" class="img-item img-thumbnail">
        <span class="precio-item">${producto.precio}</span>
        <button class="boton-item">Agregar al Carrito</button>
    `;

    // Agregar el nuevo producto al contenedor de productos en el DOM

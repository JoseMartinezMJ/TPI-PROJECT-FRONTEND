            ...
            <form action="" autocomplete="off">
                <div class="login-section2">
                    <form action="/registro" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?> <!-- Agrega un token CSRF para protección contra CSRF -->
                        <h2>Register</h2>
...
<?php /**PATH /home/edrasl/TPI/TPI-PROJECT-FRONTEND/PopBusrt/resources/views/Register.blade.php ENDPATH**/ ?>